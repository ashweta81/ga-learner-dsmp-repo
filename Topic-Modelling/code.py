...
sns.barplot(x = top_20_words, y = top_20_values, data = data)
plt.show()
...
def compute_coherence_values(dictionary, corpus, texts, limit, start=2, step=3):
    ...
    for num_topics in range(start, limit, step):
        model = gensim.models.ldamodel.LdaModel(doc_term_matrix, random_state=2,\
        num_topics =num_topics, id2word = dictionary, iterations=10)
